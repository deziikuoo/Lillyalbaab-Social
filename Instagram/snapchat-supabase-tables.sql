...
CREATE INDEX IF NOT EXISTS idx_snapchat_processed_stories_snap_id ON snapchat_processed_stories(snap_id);
...
CREATE INDEX IF NOT EXISTS idx_snapchat_recent_stories_cache_snap_id ON snapchat_recent_stories_cache(snap_id);
