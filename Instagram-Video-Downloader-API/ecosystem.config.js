module.exports = {
  apps: [
    ...
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "./Instagram-Video-Downloader-API/client/src/snapchat-frontend",
      instances: 1,
      autorestart: true,
      watch: false,
      max_memory_restart: "1G",
      ...
      error_file: "./logs/snapchat-frontend-error.log",
      out_file: "./logs/snapchat-frontend-out.log",
      log_file: "./logs/snapchat-frontend-combined.log",
      time: true,
      max_restarts: 10,
      min_uptime: "10s",
      restart_delay: 4000,
