...
- **Recent Posts**: Counts posts processed in last 24 hours
- **Activity Decay**: Activity level decreases over time
...
const API_BASE_URL = (import.meta as any).env?.VITE_IG_API_URL || 
